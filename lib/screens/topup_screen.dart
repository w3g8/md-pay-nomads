...
class _TopUpScreenState extends State<TopUpScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                const SizedBox(height: 8),
                _methodRow(Icons.credit_card, 'Visa, Mastercard, Amex'),
                _methodRow(Icons.account_balance, 'Bank Transfer (SEPA, FPS, ACH)'),
                _methodRow(Icons.phone_android, 'Mobile Money (M-Pesa, MTN, etc.)'),
                _methodRow(Icons.sync, 'USSD'),
              ]),
            ),
  ...
  Widget _methodRow(IconData icon, String label) {
    return Padding(
