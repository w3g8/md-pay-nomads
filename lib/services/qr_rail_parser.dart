...
const _railFlags = {
  QRRail.qrph: '\u{1F1F5}\u{1F1ED}',
  QRRail.promptpay: '\u{1F1F9}\u{1F1ED}',
  QRRail.qris: '\u{1F1EE}\u{1F1E9}',
  QRRail.vietqr: '\u{1F1FB}\u{1F1F3}',
  QRRail.pix: '\u{1F1E7}\u{1F1F7}',
  QRRail.paynow: '\u{1F1F8}\u{1F1EC}',
  QRRail.duitnow: '\u{1F1F2}\u{1F1FE}',
  QRRail.unknown: '\u{1F30D}',
};
...
QRRailResult? parseQRCode(String raw) {
  ...
  return QRRailResult(
    ...
    countryFlag: _railFlags[rail] ?? '\u{1F30D}',
